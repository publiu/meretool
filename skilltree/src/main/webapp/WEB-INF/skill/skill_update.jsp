...
<div class="pages navbar-through toolbar-through">
  ...
  <div data-page="skill_update" class="page">

	<div class="page-content">
		
		<div class="content-block-title">当前技能名称：${skill.skillName}-等级${skill.skillLevel }</div>
		  <!-- Inset content block -->
		  ...
		  <form action="/skill/updateSkill.action" method="post">
				    ...
				    <li class="align-top">
				      <div class="item-content">
				        ...
				        <div class="item-inner">
				          ...
				          <div class="item-input">
				            <textarea name="skillDetail">${skill.skillDetail }</textarea>
				          </div>
				        </div>
				      </div>
				    </li>
